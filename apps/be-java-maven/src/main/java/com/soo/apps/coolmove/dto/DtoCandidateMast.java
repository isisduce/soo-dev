...
public class DtoCandidateMast {
    ...
    public static DtoCandidateMast fromJson(String jsonString) {
        ObjectMapper mapper = new ObjectMapper();
        DtoCandidateMast dto = new DtoCandidateMast();
        try {
            dto = mapper.readValue(jsonString, DtoCandidateMast.class);
        } catch (Exception e) {
            return null;
        }
        return dto;
