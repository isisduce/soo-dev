...
public class EntityCandidateMast {
    ...
    private String votersCount;     // auto generated by query
    //
    ...
    public boolean isEqual(EntityCandidateMast other) {
        ...
        if (StringHelper.IsNotEqual(begDt, other.begDt)) return false;
        if (StringHelper.IsNotEqual(endDt, other.endDt)) return false;
        if (StringHelper.IsNotEqual(status, other.status)) return false;
