...
export const CandidateItem: React.FC<CandidateItemProps> = ({
    ...
    const handleClubNmChange = (value: string) => {
        onCandidateChange({ ...candidate, clubNm: value });
    };

    const handlePlayerNmChange = (value: string) => {
        onCandidateChange({ ...candidate, playerNm: value });
    };
    ...
    const handlePledgeChange = (index: number, value: string) => {
        ...
        onCandidateChange({ ...candidate, pledges: newPledges });
    };
    ...
    return (
        <div className={`candidate-${candidateNumber === 1 ? '01' : '02'}`}>
            <div className="candidate-tit">후보자 {candidateNumber} 등록</div>
            <div className="candidate-input-group">
                ...
                <div className="flex-group">
                    ...
                    <button
                        ...
                        title={`후보자 ${candidateNumber} 사진 업로드`}
                        aria-label={`후보자 ${candidateNumber} 사진 업로드`}
                        style={{
                            backgroundImage:
                ...
                <div className={`promise-input-area promise-input-area${candidateNumber === 1 ? '01' : '02'}`}>
