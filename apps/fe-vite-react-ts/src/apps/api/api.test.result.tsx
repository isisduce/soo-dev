...
export const ApiTestResult = (props: ApiTestResultProps) => {
    ...
    return (
        <Box style={{ flex: 1, gap: '10px', padding: 0, width: '100%', height: '100%', backgroundColor: bgColor }}>
            <Box style={{ display: 'flex', alignItems: 'center', justifyItems: 'center', backgroundColor: '#bbb', height: 30, padding: '4px 8px' }}>
            ...
            <Box style={{ flex: 1, width: '100%', overflow: 'auto', height: '100%' }}>
